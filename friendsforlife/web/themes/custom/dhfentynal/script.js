(function ($,jQuery) {
  ...
  $(document).ready(function() {
    ...
    if (currentUrl.indexOf("es") !== -1) {
      $( this ).find( ".field--name-field-preview-pdf a.file-download.file-download-pdf" ).html('Vista previa');
    }
    $( '.page-node-9 .paragraph .field--name-field-description' ).hide();
    $( ".page-node-9 .paragraph--type--toolkit .field--name-field-tiles .field__item" ).each( function() {
      var desc = $( this ).find( '.paragraph .field--name-field-description' ).text();
      if(desc != '') {
    ...
    $( ".page-node-12 .paragraph--type--toolkit .field--name-field-tiles .field__item" ).each( function() {
      var desc = $( this ).find( '.paragraph .field--name-field-description' ).text();
      if(desc != '') {
    ...
    $( ".page-node-13 .paragraph--type--toolkit .field--name-field-tiles .field__item" ).each( function() {
      var desc = $( this ).find( '.paragraph .field--name-field-description' ).text();
      if(desc != '') {
        $( this ).find( "a.file-download" ).html(desc);
      }
  ...
  $(document).ready(function () {
    ...
    $('a.site-logo, .sticky-top1 .nav-link, .dropdown-item, .view-toolkit-view .views-row , .tookkittiles .views-row').each(function (i) {
